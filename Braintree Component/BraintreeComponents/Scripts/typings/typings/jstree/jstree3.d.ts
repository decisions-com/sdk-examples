// Type definitions for jsTree3 v3.3.1 
...
interface JQuery {
     ...
     */
    jstree(): JSTree3;
    jstree(options: JSTree3StaticDefaults): JSTree3;
    jstree(arg: boolean): JSTree3;
    jstree(...args: any[]): any;
}

interface JSTree3Static {
    /**
     ...
     */
    defaults: JSTree3StaticDefaults;
    ...
    */
     ...
     * @return {jsTree3} the new instance
     */
    create(el: HTMLElement | JQuery | string, options?: JSTree3StaticDefaults): JSTree3;
    ...
    *	$.jstree.reference('tree');
	 ...
	 * @return {jsTree3|null} the instance or `null` if not found
	 */
    reference(needle: HTMLElement | JQuery | string): JSTree3;
}

interface JSTree3StaticDefaults {
    /**
     ...
     */
    core: JSTree3StaticDefaultsCore;

    /**
    * stores all defaults for the checkbox plugin
    */
    checkbox?: JSTree3StaticDefaultsCheckbox;

    /**
    * stores all defaults for the contextmenu plugin
    */
    contextmenu?: JSTree3StaticDefaultsContextMenu;

    /**
    * stores all defaults for the drag'n'drop plugin
    */
    dnd?: JSTree3StaticDefaultsDragNDrop;

    /**
     * Adds massload functionality to jsTree3, so that multiple nodes can be loaded in a single request (only useful with lazy loading).
     */
    massload?: JSTree3StaticDefaultsMassload;

    /**
    * stores all defaults for the search plugin
    */
    search?: JSTree3StaticDefaultsSearch;
    ...
    */
    state?: JSTree3StaticDefaultsState;
    ...
    * @plugin unique
    */
    unique?: JSTree3StaticDefaultsUnique;
}

interface JSTree3StaticDefaultsCore {
    /**
    * data configuration
    * 
    ...
    */
    themes?: JSTree3StaticDefaultsCoreThemes;
...
interface JSTree3StaticDefaultsCoreThemes {
    /**
...
interface JSTree3StaticDefaultsCheckbox {
    /**
...
interface JSTree3StaticDefaultsContextMenu {
    /**
...
interface JSTree3StaticDefaultsDragNDrop {
    /**
...
interface JSTree3StaticDefaultsMassload {
    /**
...
interface JSTree3StaticDefaultsSearch {
    /**
...
interface JSTree3StaticDefaultsState {
    /**
...
interface JSTree3StaticDefaultsUnique {
    /**
...
interface JSTree3 extends JQuery {
    /**
    ...
    * @return {jsTree3}
    */
    plugin: (deco: string, opts?: any) => JSTree3;
    ...
    * @return {Object}
    */
    get_json: (obj?: any, options?: JSTree3GetJsonOptions, flat?: boolean) => any;
...
interface JSTree3GetJsonOptions {
    /**
