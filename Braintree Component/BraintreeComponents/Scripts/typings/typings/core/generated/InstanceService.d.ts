...
interface InstanceServiceStatic {

	GetAllInstances(successCallback: (data: { GetAllInstancesResult: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData[] }) => any, errorCallback?: () => any): JQueryPromise<{ GetAllInstancesResult: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData[] }>;

	GetAllInstances(): { GetAllInstancesResult: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData[] };

	GetAllInstancesPromise(): Promise<$D.Framework.ServiceLayer.Services.ServerManagement.InstanceData[]>;

	GetInstanceByName(instanceName: string, successCallback: (data: { GetInstanceByNameResult: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData }) => any, errorCallback?: () => any): JQueryPromise<{ GetInstanceByNameResult: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData }>;

	GetInstanceByName(instanceName: string): { GetInstanceByNameResult: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData };

	GetInstanceByNamePromise(instanceName: string): Promise<$D.Framework.ServiceLayer.Services.ServerManagement.InstanceData>;

	AddInstance(folderId: string, instanceName: string, dbName: string, dbServerName: string, description: string, successCallback: (data: { AddInstanceResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ AddInstanceResult: string }>;

	AddInstance(folderId: string, instanceName: string, dbName: string, dbServerName: string, description: string): { AddInstanceResult: string };

	AddInstancePromise(folderId: string, instanceName: string, dbName: string, dbServerName: string, description: string): Promise<string>;

	AddInstanceFromHostingConfiguration(folderId: string, instanceName: string, dbName: string, dbServerName: string, description: string, hostingConfigurationId: string, successCallback: (data: { AddInstanceFromHostingConfigurationResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ AddInstanceFromHostingConfigurationResult: string }>;

	AddInstanceFromHostingConfiguration(folderId: string, instanceName: string, dbName: string, dbServerName: string, description: string, hostingConfigurationId: string): { AddInstanceFromHostingConfigurationResult: string };

	AddInstanceFromHostingConfigurationPromise(folderId: string, instanceName: string, dbName: string, dbServerName: string, description: string, hostingConfigurationId: string): Promise<string>;

	CreateInstance(instanceId: string, parentFolderId: string, instanceName: string, dbName: string, dbServerName: string, description: string, successCallback: (data: { CreateInstanceResult: $D.Framework.ServiceLayer.Services.Folder.Folder }) => any, errorCallback?: () => any): JQueryPromise<{ CreateInstanceResult: $D.Framework.ServiceLayer.Services.Folder.Folder }>;

	CreateInstance(instanceId: string, parentFolderId: string, instanceName: string, dbName: string, dbServerName: string, description: string): { CreateInstanceResult: $D.Framework.ServiceLayer.Services.Folder.Folder };

	CreateInstancePromise(instanceId: string, parentFolderId: string, instanceName: string, dbName: string, dbServerName: string, description: string): Promise<$D.Framework.ServiceLayer.Services.Folder.Folder>;

	CloneInstance(instanceId: string, newInstanceName: string, newDatabaseName: string, instanceBaseUrl: string, successCallback: (data: { CloneInstanceResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ CloneInstanceResult: void }>;

	CloneInstance(instanceId: string, newInstanceName: string, newDatabaseName: string, instanceBaseUrl: string): { CloneInstanceResult: void };

	CloneInstancePromise(instanceId: string, newInstanceName: string, newDatabaseName: string, instanceBaseUrl: string): Promise<void>;

	CanCreateInstance(instanceName: string, dbName: string, dbServerName: string, successCallback: (data: { CanCreateInstanceResult: boolean }) => any, errorCallback?: () => any): JQueryPromise<{ CanCreateInstanceResult: boolean }>;

	CanCreateInstance(instanceName: string, dbName: string, dbServerName: string): { CanCreateInstanceResult: boolean };

	CanCreateInstancePromise(instanceName: string, dbName: string, dbServerName: string): Promise<boolean>;

	GetInstanceDataByFolderId(instanceId: string, successCallback: (data: { GetInstanceDataByFolderIdResult: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData }) => any, errorCallback?: () => any): JQueryPromise<{ GetInstanceDataByFolderIdResult: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData }>;

	GetInstanceDataByFolderId(instanceId: string): { GetInstanceDataByFolderIdResult: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData };

	GetInstanceDataByFolderIdPromise(instanceId: string): Promise<$D.Framework.ServiceLayer.Services.ServerManagement.InstanceData>;

	GetUserInstances(email: string, successCallback: (data: { GetUserInstancesResult: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData[] }) => any, errorCallback?: () => any): JQueryPromise<{ GetUserInstancesResult: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData[] }>;

	GetUserInstances(email: string): { GetUserInstancesResult: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData[] };

	GetUserInstancesPromise(email: string): Promise<$D.Framework.ServiceLayer.Services.ServerManagement.InstanceData[]>;

	GetInstancesInFolder(folderId: string, successCallback: (data: { GetInstancesInFolderResult: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData[] }) => any, errorCallback?: () => any): JQueryPromise<{ GetInstancesInFolderResult: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData[] }>;

	GetInstancesInFolder(folderId: string): { GetInstancesInFolderResult: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData[] };

	GetInstancesInFolderPromise(folderId: string): Promise<$D.Framework.ServiceLayer.Services.ServerManagement.InstanceData[]>;
	...
	StopAllInstances(successCallback: (data: { StopAllInstancesResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ StopAllInstancesResult: void }>;

	StopAllInstances(): { StopAllInstancesResult: void };

	StopAllInstancesPromise(): Promise<void>;
	...
	StartAllInstances(successCallback: (data: { StartAllInstancesResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ StartAllInstancesResult: void }>;

	StartAllInstances(): { StartAllInstancesResult: void };

	StartAllInstancesPromise(): Promise<void>;

	MoveInstanceToServer(instanceId: string, serverId: string, successCallback: (data: { MoveInstanceToServerResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ MoveInstanceToServerResult: void }>;

	MoveInstanceToServer(instanceId: string, serverId: string): { MoveInstanceToServerResult: void };

	MoveInstanceToServerPromise(instanceId: string, serverId: string): Promise<void>;

	StopInstanceOnAllServers(instanceId: string, successCallback: (data: { StopInstanceOnAllServersResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ StopInstanceOnAllServersResult: void }>;

	StopInstanceOnAllServers(instanceId: string): { StopInstanceOnAllServersResult: void };

	StopInstanceOnAllServersPromise(instanceId: string): Promise<void>;

	GetInstanceStatusOnCurrentServer(instanceId: string, successCallback: (data: { GetInstanceStatusOnCurrentServerResult: any }) => any, errorCallback?: () => any): JQueryPromise<{ GetInstanceStatusOnCurrentServerResult: any }>;

	GetInstanceStatusOnCurrentServer(instanceId: string): { GetInstanceStatusOnCurrentServerResult: any };

	GetInstanceStatusOnCurrentServerPromise(instanceId: string): Promise<any>;

	TestInstanceDatabaseConnection(instanceId: string, serverOnly: boolean, successCallback: (data: { TestInstanceDatabaseConnectionResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ TestInstanceDatabaseConnectionResult: void }>;

	TestInstanceDatabaseConnection(instanceId: string, serverOnly: boolean): { TestInstanceDatabaseConnectionResult: void };

	TestInstanceDatabaseConnectionPromise(instanceId: string, serverOnly: boolean): Promise<void>;

	DeleteInstance(instanceId: string, successCallback: (data: { DeleteInstanceResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ DeleteInstanceResult: void }>;

	DeleteInstance(instanceId: string): { DeleteInstanceResult: void };

	DeleteInstancePromise(instanceId: string): Promise<void>;

	DeleteInstanceWithDatabase(instanceId: string, successCallback: (data: { DeleteInstanceWithDatabaseResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ DeleteInstanceWithDatabaseResult: void }>;

	DeleteInstanceWithDatabase(instanceId: string): { DeleteInstanceWithDatabaseResult: void };

	DeleteInstanceWithDatabasePromise(instanceId: string): Promise<void>;

	CheckInstanceDatabaseExists(dbServerName: string, dbName: string, successCallback: (data: { CheckInstanceDatabaseExistsResult: boolean }) => any, errorCallback?: () => any): JQueryPromise<{ CheckInstanceDatabaseExistsResult: boolean }>;

	CheckInstanceDatabaseExists(dbServerName: string, dbName: string): { CheckInstanceDatabaseExistsResult: boolean };

	CheckInstanceDatabaseExistsPromise(dbServerName: string, dbName: string): Promise<boolean>;

	SetupInstancePlatformServer(instanceId: string, platformServerSettings: $D.Framework.ServiceLayer.Services.ServerManagement.PlatformServerSettings, successCallback: (data: { SetupInstancePlatformServerResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ SetupInstancePlatformServerResult: void }>;

	SetupInstancePlatformServer(instanceId: string, platformServerSettings: $D.Framework.ServiceLayer.Services.ServerManagement.PlatformServerSettings): { SetupInstancePlatformServerResult: void };

	SetupInstancePlatformServerPromise(instanceId: string, platformServerSettings: $D.Framework.ServiceLayer.Services.ServerManagement.PlatformServerSettings): Promise<void>;

	SyncAccounts(instanceId: string, successCallback: (data: { SyncAccountsResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ SyncAccountsResult: void }>;

	SyncAccounts(instanceId: string): { SyncAccountsResult: void };

	SyncAccountsPromise(instanceId: string): Promise<void>;

	ActivateInstanceAccounts(instanceId: string, successCallback: (data: { ActivateInstanceAccountsResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ ActivateInstanceAccountsResult: void }>;

	ActivateInstanceAccounts(instanceId: string): { ActivateInstanceAccountsResult: void };

	ActivateInstanceAccountsPromise(instanceId: string): Promise<void>;

	DeactivateInstanceAccounts(instanceId: string, successCallback: (data: { DeactivateInstanceAccountsResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ DeactivateInstanceAccountsResult: void }>;

	DeactivateInstanceAccounts(instanceId: string): { DeactivateInstanceAccountsResult: void };

	DeactivateInstanceAccountsPromise(instanceId: string): Promise<void>;

	GetInstanceAccountEmails(instanceId: string, successCallback: (data: { GetInstanceAccountEmailsResult: string[] }) => any, errorCallback?: () => any): JQueryPromise<{ GetInstanceAccountEmailsResult: string[] }>;

	GetInstanceAccountEmails(instanceId: string): { GetInstanceAccountEmailsResult: string[] };

	GetInstanceAccountEmailsPromise(instanceId: string): Promise<string[]>;

	SetInstanceAccounts(instanceId: string, accountEmails: string[], successCallback: (data: { SetInstanceAccountsResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ SetInstanceAccountsResult: void }>;

	SetInstanceAccounts(instanceId: string, accountEmails: string[]): { SetInstanceAccountsResult: void };

	SetInstanceAccountsPromise(instanceId: string, accountEmails: string[]): Promise<void>;

	AssignAccountToInstanceByEmail(instanceId: string, accountEmail: string, successCallback: (data: { AssignAccountToInstanceByEmailResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ AssignAccountToInstanceByEmailResult: void }>;

	AssignAccountToInstanceByEmail(instanceId: string, accountEmail: string): { AssignAccountToInstanceByEmailResult: void };

	AssignAccountToInstanceByEmailPromise(instanceId: string, accountEmail: string): Promise<void>;

	AssignAccountToInstance(instanceId: string, accountId: string, successCallback: (data: { AssignAccountToInstanceResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ AssignAccountToInstanceResult: void }>;

	AssignAccountToInstance(instanceId: string, accountId: string): { AssignAccountToInstanceResult: void };

	AssignAccountToInstancePromise(instanceId: string, accountId: string): Promise<void>;

	AssignAccountToInstanceAndSetAdmin(instanceId: string, accountId: string, isAdmin: boolean, successCallback: (data: { AssignAccountToInstanceAndSetAdminResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ AssignAccountToInstanceAndSetAdminResult: void }>;

	AssignAccountToInstanceAndSetAdmin(instanceId: string, accountId: string, isAdmin: boolean): { AssignAccountToInstanceAndSetAdminResult: void };

	AssignAccountToInstanceAndSetAdminPromise(instanceId: string, accountId: string, isAdmin: boolean): Promise<void>;

	UnassignAccountFromInstanceByEmail(instanceId: string, accountEmail: string, successCallback: (data: { UnassignAccountFromInstanceByEmailResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ UnassignAccountFromInstanceByEmailResult: void }>;

	UnassignAccountFromInstanceByEmail(instanceId: string, accountEmail: string): { UnassignAccountFromInstanceByEmailResult: void };

	UnassignAccountFromInstanceByEmailPromise(instanceId: string, accountEmail: string): Promise<void>;

	UnassignAccountFromInstance(instanceId: string, accountId: string, successCallback: (data: { UnassignAccountFromInstanceResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ UnassignAccountFromInstanceResult: void }>;

	UnassignAccountFromInstance(instanceId: string, accountId: string): { UnassignAccountFromInstanceResult: void };

	UnassignAccountFromInstancePromise(instanceId: string, accountId: string): Promise<void>;

	GetAccountInstances(accountID: string, successCallback: (data: { GetAccountInstancesResult: string[] }) => any, errorCallback?: () => any): JQueryPromise<{ GetAccountInstancesResult: string[] }>;

	GetAccountInstances(accountID: string): { GetAccountInstancesResult: string[] };

	GetAccountInstancesPromise(accountID: string): Promise<string[]>;

	SetInstanceAdminAccount(instanceId: string, adminAccountEmail: string, successCallback: (data: { SetInstanceAdminAccountResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ SetInstanceAdminAccountResult: void }>;

	SetInstanceAdminAccount(instanceId: string, adminAccountEmail: string): { SetInstanceAdminAccountResult: void };

	SetInstanceAdminAccountPromise(instanceId: string, adminAccountEmail: string): Promise<void>;

	UnSetInstanceAdminAccount(instanceId: string, adminAccountEmail: string, successCallback: (data: { UnSetInstanceAdminAccountResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ UnSetInstanceAdminAccountResult: void }>;

	UnSetInstanceAdminAccount(instanceId: string, adminAccountEmail: string): { UnSetInstanceAdminAccountResult: void };

	UnSetInstanceAdminAccountPromise(instanceId: string, adminAccountEmail: string): Promise<void>;

	BackupInstanceDatabaseToFile(instanceId: string, makeUniqueFileName: boolean, successCallback: (data: { BackupInstanceDatabaseToFileResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ BackupInstanceDatabaseToFileResult: void }>;

	BackupInstanceDatabaseToFile(instanceId: string, makeUniqueFileName: boolean): { BackupInstanceDatabaseToFileResult: void };

	BackupInstanceDatabaseToFilePromise(instanceId: string, makeUniqueFileName: boolean): Promise<void>;

	AccountIsInstanceUser(userEmail: string, successCallback: (data: { AccountIsInstanceUserResult: boolean }) => any, errorCallback?: () => any): JQueryPromise<{ AccountIsInstanceUserResult: boolean }>;

	AccountIsInstanceUser(userEmail: string): { AccountIsInstanceUserResult: boolean };

	AccountIsInstanceUserPromise(userEmail: string): Promise<boolean>;

	ChangeInstanceOwner(instanceId: string, accountId: string, successCallback: (data: { ChangeInstanceOwnerResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ ChangeInstanceOwnerResult: void }>;

	ChangeInstanceOwner(instanceId: string, accountId: string): { ChangeInstanceOwnerResult: void };

	ChangeInstanceOwnerPromise(instanceId: string, accountId: string): Promise<void>;

	SetAccountToInstances(accountId: string, instanceIds: string[], successCallback: (data: { SetAccountToInstancesResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ SetAccountToInstancesResult: void }>;

	SetAccountToInstances(accountId: string, instanceIds: string[]): { SetAccountToInstancesResult: void };

	SetAccountToInstancesPromise(accountId: string, instanceIds: string[]): Promise<void>;

	GetContractAccounts(contractFolderId: string, successCallback: (data: { GetContractAccountsResult: $D.Framework.Data.ORMapper.EntityHeaderData[] }) => any, errorCallback?: () => any): JQueryPromise<{ GetContractAccountsResult: $D.Framework.Data.ORMapper.EntityHeaderData[] }>;

	GetContractAccounts(contractFolderId: string): { GetContractAccountsResult: $D.Framework.Data.ORMapper.EntityHeaderData[] };

	GetContractAccountsPromise(contractFolderId: string): Promise<$D.Framework.Data.ORMapper.EntityHeaderData[]>;
	...
	Create(name: string, description: string, parentFolderID: string, data: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData, successCallback: (data: { CreateResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ CreateResult: string }>;

	Create(name: string, description: string, parentFolderID: string, data: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData): { CreateResult: string };

	CreatePromise(name: string, description: string, parentFolderID: string, data: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData): Promise<string>;

	FetchData(folderEntityID: string, successCallback: (data: { FetchDataResult: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData }) => any, errorCallback?: () => any): JQueryPromise<{ FetchDataResult: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData }>;

	FetchData(folderEntityID: string): { FetchDataResult: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData };

	FetchDataPromise(folderEntityID: string): Promise<$D.Framework.ServiceLayer.Services.ServerManagement.InstanceData>;
	...
	SaveFolderWithData(folderEntityID: string, data: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData, successCallback: (data: { SaveFolderWithDataResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ SaveFolderWithDataResult: void }>;

	SaveFolderWithData(folderEntityID: string, data: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData): { SaveFolderWithDataResult: void };

	SaveFolderWithDataPromise(folderEntityID: string, data: $D.Framework.ServiceLayer.Services.ServerManagement.InstanceData): Promise<void>;

	GetMyModuleRights(userContext: $D.Framework.ServiceLayer.Utilities.AbstractUserContext, successCallback: (data: { GetMyModuleRightsResult: $D.Framework.ServiceLayer.Services.Administration.PortalAdministratorModuleRight }) => any, errorCallback?: () => any): JQueryPromise<{ GetMyModuleRightsResult: $D.Framework.ServiceLayer.Services.Administration.PortalAdministratorModuleRight }>;

	GetMyModuleRights(userContext: $D.Framework.ServiceLayer.Utilities.AbstractUserContext): { GetMyModuleRightsResult: $D.Framework.ServiceLayer.Services.Administration.PortalAdministratorModuleRight };

	GetMyModuleRightsPromise(userContext: $D.Framework.ServiceLayer.Utilities.AbstractUserContext): Promise<$D.Framework.ServiceLayer.Services.Administration.PortalAdministratorModuleRight>;

	GetAccountModuleRights(accountID: string, successCallback: (data: { GetAccountModuleRightsResult: $D.Framework.ServiceLayer.Services.Administration.PortalAdministratorModuleRight }) => any, errorCallback?: () => any): JQueryPromise<{ GetAccountModuleRightsResult: $D.Framework.ServiceLayer.Services.Administration.PortalAdministratorModuleRight }>;

	GetAccountModuleRights(accountID: string): { GetAccountModuleRightsResult: $D.Framework.ServiceLayer.Services.Administration.PortalAdministratorModuleRight };

	GetAccountModuleRightsPromise(accountID: string): Promise<$D.Framework.ServiceLayer.Services.Administration.PortalAdministratorModuleRight>;

	SetAccountModuleRights(accountID: string, moduleRights: $D.Framework.ServiceLayer.Services.Administration.PortalAdministratorModuleRight, successCallback: (data: { SetAccountModuleRightsResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ SetAccountModuleRightsResult: void }>;

	SetAccountModuleRights(accountID: string, moduleRights: $D.Framework.ServiceLayer.Services.Administration.PortalAdministratorModuleRight): { SetAccountModuleRightsResult: void };

	SetAccountModuleRightsPromise(accountID: string, moduleRights: $D.Framework.ServiceLayer.Services.Administration.PortalAdministratorModuleRight): Promise<void>;

	GetGroupModuleRights(groupID: string, successCallback: (data: { GetGroupModuleRightsResult: $D.Framework.ServiceLayer.Services.Administration.PortalAdministratorModuleRight }) => any, errorCallback?: () => any): JQueryPromise<{ GetGroupModuleRightsResult: $D.Framework.ServiceLayer.Services.Administration.PortalAdministratorModuleRight }>;

	GetGroupModuleRights(groupID: string): { GetGroupModuleRightsResult: $D.Framework.ServiceLayer.Services.Administration.PortalAdministratorModuleRight };

	GetGroupModuleRightsPromise(groupID: string): Promise<$D.Framework.ServiceLayer.Services.Administration.PortalAdministratorModuleRight>;

	SetGroupModuleRights(groupID: string, moduleRights: $D.Framework.ServiceLayer.Services.Administration.PortalAdministratorModuleRight, successCallback: (data: { SetGroupModuleRightsResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ SetGroupModuleRightsResult: void }>;

	SetGroupModuleRights(groupID: string, moduleRights: $D.Framework.ServiceLayer.Services.Administration.PortalAdministratorModuleRight): { SetGroupModuleRightsResult: void };

	SetGroupModuleRightsPromise(groupID: string, moduleRights: $D.Framework.ServiceLayer.Services.Administration.PortalAdministratorModuleRight): Promise<void>;
}

interface ServicesStatic {
	InstanceService(): InstanceServiceStatic;
}
