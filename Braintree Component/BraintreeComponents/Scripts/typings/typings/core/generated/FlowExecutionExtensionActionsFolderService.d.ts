...
interface FlowExecutionExtensionActionsFolderServiceStatic {

	CreateFlowExecutionExtentionActionFlow(folderId: string, templateId: string, name: string, successCallback: (data: { CreateFlowExecutionExtentionActionFlowResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ CreateFlowExecutionExtentionActionFlowResult: string }>;

	CreateFlowExecutionExtentionActionFlow(folderId: string, templateId: string, name: string): { CreateFlowExecutionExtentionActionFlowResult: string };

	CreateFlowExecutionExtentionActionFlowPromise(folderId: string, templateId: string, name: string): Promise<string>;
	...
	Create(name: string, description: string, parentFolderID: string, data: $D.Framework.Design.EntityActions.FlowExecutionExtensionActionsFolderExtention, successCallback: (data: { CreateResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ CreateResult: string }>;

	Create(name: string, description: string, parentFolderID: string, data: $D.Framework.Design.EntityActions.FlowExecutionExtensionActionsFolderExtention): { CreateResult: string };

	CreatePromise(name: string, description: string, parentFolderID: string, data: $D.Framework.Design.EntityActions.FlowExecutionExtensionActionsFolderExtention): Promise<string>;

	FetchData(folderEntityID: string, successCallback: (data: { FetchDataResult: $D.Framework.Design.EntityActions.FlowExecutionExtensionActionsFolderExtention }) => any, errorCallback?: () => any): JQueryPromise<{ FetchDataResult: $D.Framework.Design.EntityActions.FlowExecutionExtensionActionsFolderExtention }>;

	FetchData(folderEntityID: string): { FetchDataResult: $D.Framework.Design.EntityActions.FlowExecutionExtensionActionsFolderExtention };

	FetchDataPromise(folderEntityID: string): Promise<$D.Framework.Design.EntityActions.FlowExecutionExtensionActionsFolderExtention>;
	...
	SaveFolderWithData(folderEntityID: string, data: $D.Framework.Design.EntityActions.FlowExecutionExtensionActionsFolderExtention, successCallback: (data: { SaveFolderWithDataResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ SaveFolderWithDataResult: void }>;

	SaveFolderWithData(folderEntityID: string, data: $D.Framework.Design.EntityActions.FlowExecutionExtensionActionsFolderExtention): { SaveFolderWithDataResult: void };

	SaveFolderWithDataPromise(folderEntityID: string, data: $D.Framework.Design.EntityActions.FlowExecutionExtensionActionsFolderExtention): Promise<void>;
}

interface ServicesStatic {
	FlowExecutionExtensionActionsFolderService(): FlowExecutionExtensionActionsFolderServiceStatic;
}
