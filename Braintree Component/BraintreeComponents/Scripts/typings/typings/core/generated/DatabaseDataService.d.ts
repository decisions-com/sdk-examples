...
interface DatabaseDataServiceStatic {
	...
	StartTestConnection(type: $D.Framework.ServiceLayer.DataBaseTypeEnum, connectionString: string, agentId: string, useCurrentDatabase: boolean, successCallback: (data: { StartTestConnectionResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ StartTestConnectionResult: string }>;

	StartTestConnection(type: $D.Framework.ServiceLayer.DataBaseTypeEnum, connectionString: string, agentId: string, useCurrentDatabase: boolean): { StartTestConnectionResult: string };

	StartTestConnectionPromise(type: $D.Framework.ServiceLayer.DataBaseTypeEnum, connectionString: string, agentId: string, useCurrentDatabase: boolean): Promise<string>;

	StartGetAllTableDefinitions(type: $D.Framework.ServiceLayer.DataBaseTypeEnum, connectionString: string, agentId: string, useCurrentDatabase: boolean, flowId: string, successCallback: (data: { StartGetAllTableDefinitionsResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ StartGetAllTableDefinitionsResult: string }>;

	StartGetAllTableDefinitions(type: $D.Framework.ServiceLayer.DataBaseTypeEnum, connectionString: string, agentId: string, useCurrentDatabase: boolean, flowId: string): { StartGetAllTableDefinitionsResult: string };

	StartGetAllTableDefinitionsPromise(type: $D.Framework.ServiceLayer.DataBaseTypeEnum, connectionString: string, agentId: string, useCurrentDatabase: boolean, flowId: string): Promise<string>;

	GetGetAllTableDefinitionsResult(requestId: string, successCallback: (data: { GetGetAllTableDefinitionsResultResult: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseTableDefinition[] }) => any, errorCallback?: () => any): JQueryPromise<{ GetGetAllTableDefinitionsResultResult: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseTableDefinition[] }>;

	GetGetAllTableDefinitionsResult(requestId: string): { GetGetAllTableDefinitionsResultResult: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseTableDefinition[] };

	GetGetAllTableDefinitionsResultPromise(requestId: string): Promise<$D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseTableDefinition[]>;

	StartGetAllViewDefinitions(type: $D.Framework.ServiceLayer.DataBaseTypeEnum, connectionString: string, agentId: string, useCurrentDatabase: boolean, flowId: string, successCallback: (data: { StartGetAllViewDefinitionsResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ StartGetAllViewDefinitionsResult: string }>;

	StartGetAllViewDefinitions(type: $D.Framework.ServiceLayer.DataBaseTypeEnum, connectionString: string, agentId: string, useCurrentDatabase: boolean, flowId: string): { StartGetAllViewDefinitionsResult: string };

	StartGetAllViewDefinitionsPromise(type: $D.Framework.ServiceLayer.DataBaseTypeEnum, connectionString: string, agentId: string, useCurrentDatabase: boolean, flowId: string): Promise<string>;

	GetGetAllViewDefinitionsResult(requestId: string, successCallback: (data: { GetGetAllViewDefinitionsResultResult: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseViewDefinition[] }) => any, errorCallback?: () => any): JQueryPromise<{ GetGetAllViewDefinitionsResultResult: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseViewDefinition[] }>;

	GetGetAllViewDefinitionsResult(requestId: string): { GetGetAllViewDefinitionsResultResult: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseViewDefinition[] };

	GetGetAllViewDefinitionsResultPromise(requestId: string): Promise<$D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseViewDefinition[]>;

	StartGetAllTableInfo(connectionInfo: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData, successCallback: (data: { StartGetAllTableInfoResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ StartGetAllTableInfoResult: string }>;

	StartGetAllTableInfo(connectionInfo: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData): { StartGetAllTableInfoResult: string };

	StartGetAllTableInfoPromise(connectionInfo: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData): Promise<string>;

	GetGetAllTableInfoResult(requestId: string, successCallback: (data: { GetGetAllTableInfoResultResult: $D.Framework.Data.DataTypes.DBTableInfo[] }) => any, errorCallback?: () => any): JQueryPromise<{ GetGetAllTableInfoResultResult: $D.Framework.Data.DataTypes.DBTableInfo[] }>;

	GetGetAllTableInfoResult(requestId: string): { GetGetAllTableInfoResultResult: $D.Framework.Data.DataTypes.DBTableInfo[] };

	GetGetAllTableInfoResultPromise(requestId: string): Promise<$D.Framework.Data.DataTypes.DBTableInfo[]>;

	StartGetAllViewInfo(connectionInfo: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData, successCallback: (data: { StartGetAllViewInfoResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ StartGetAllViewInfoResult: string }>;

	StartGetAllViewInfo(connectionInfo: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData): { StartGetAllViewInfoResult: string };

	StartGetAllViewInfoPromise(connectionInfo: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData): Promise<string>;

	GetGetAllViewInfoResult(requestId: string, successCallback: (data: { GetGetAllViewInfoResultResult: $D.Framework.Data.DataTypes.DBTableInfo[] }) => any, errorCallback?: () => any): JQueryPromise<{ GetGetAllViewInfoResultResult: $D.Framework.Data.DataTypes.DBTableInfo[] }>;

	GetGetAllViewInfoResult(requestId: string): { GetGetAllViewInfoResultResult: $D.Framework.Data.DataTypes.DBTableInfo[] };

	GetGetAllViewInfoResultPromise(requestId: string): Promise<$D.Framework.Data.DataTypes.DBTableInfo[]>;

	StartGetAllProcedureDefinitions(type: $D.Framework.ServiceLayer.DataBaseTypeEnum, connectionString: string, agentId: string, useCurrentDatabase: boolean, flowId: string, successCallback: (data: { StartGetAllProcedureDefinitionsResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ StartGetAllProcedureDefinitionsResult: string }>;

	StartGetAllProcedureDefinitions(type: $D.Framework.ServiceLayer.DataBaseTypeEnum, connectionString: string, agentId: string, useCurrentDatabase: boolean, flowId: string): { StartGetAllProcedureDefinitionsResult: string };

	StartGetAllProcedureDefinitionsPromise(type: $D.Framework.ServiceLayer.DataBaseTypeEnum, connectionString: string, agentId: string, useCurrentDatabase: boolean, flowId: string): Promise<string>;

	GetGetAllProcedureDefinitionsResult(requestId: string, successCallback: (data: { GetGetAllProcedureDefinitionsResultResult: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseStoredProcedureDefinition[] }) => any, errorCallback?: () => any): JQueryPromise<{ GetGetAllProcedureDefinitionsResultResult: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseStoredProcedureDefinition[] }>;

	GetGetAllProcedureDefinitionsResult(requestId: string): { GetGetAllProcedureDefinitionsResultResult: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseStoredProcedureDefinition[] };

	GetGetAllProcedureDefinitionsResultPromise(requestId: string): Promise<$D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseStoredProcedureDefinition[]>;

	StartGetAllTableFields(tableName: string, schemaName: string, databaseId: string, successCallback: (data: { StartGetAllTableFieldsResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ StartGetAllTableFieldsResult: string }>;

	StartGetAllTableFields(tableName: string, schemaName: string, databaseId: string): { StartGetAllTableFieldsResult: string };

	StartGetAllTableFieldsPromise(tableName: string, schemaName: string, databaseId: string): Promise<string>;

	StartGetAllTableFieldsByConnection(tableName: string, schemaName: string, connectionInfo: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData, successCallback: (data: { StartGetAllTableFieldsByConnectionResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ StartGetAllTableFieldsByConnectionResult: string }>;

	StartGetAllTableFieldsByConnection(tableName: string, schemaName: string, connectionInfo: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData): { StartGetAllTableFieldsByConnectionResult: string };

	StartGetAllTableFieldsByConnectionPromise(tableName: string, schemaName: string, connectionInfo: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData): Promise<string>;

	GetGetAllTableFieldsResult(requestId: string, successCallback: (data: { GetGetAllTableFieldsResultResult: $D.Framework.ServiceLayer.Services.DatabaseIntegration.IntegrationDefinitions.ParameterDefinition[] }) => any, errorCallback?: () => any): JQueryPromise<{ GetGetAllTableFieldsResultResult: $D.Framework.ServiceLayer.Services.DatabaseIntegration.IntegrationDefinitions.ParameterDefinition[] }>;

	GetGetAllTableFieldsResult(requestId: string): { GetGetAllTableFieldsResultResult: $D.Framework.ServiceLayer.Services.DatabaseIntegration.IntegrationDefinitions.ParameterDefinition[] };

	GetGetAllTableFieldsResultPromise(requestId: string): Promise<$D.Framework.ServiceLayer.Services.DatabaseIntegration.IntegrationDefinitions.ParameterDefinition[]>;

	StartGetAllKeyFieldNames(tableName: string, schemaName: string, databaseId: string, successCallback: (data: { StartGetAllKeyFieldNamesResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ StartGetAllKeyFieldNamesResult: string }>;

	StartGetAllKeyFieldNames(tableName: string, schemaName: string, databaseId: string): { StartGetAllKeyFieldNamesResult: string };

	StartGetAllKeyFieldNamesPromise(tableName: string, schemaName: string, databaseId: string): Promise<string>;

	StartGetAllKeyFieldNamesByConnection(tableName: string, schemaName: string, connectionInfo: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData, successCallback: (data: { StartGetAllKeyFieldNamesByConnectionResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ StartGetAllKeyFieldNamesByConnectionResult: string }>;

	StartGetAllKeyFieldNamesByConnection(tableName: string, schemaName: string, connectionInfo: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData): { StartGetAllKeyFieldNamesByConnectionResult: string };

	StartGetAllKeyFieldNamesByConnectionPromise(tableName: string, schemaName: string, connectionInfo: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData): Promise<string>;

	GetGetAllKeyFieldNamesResult(requestId: string, successCallback: (data: { GetGetAllKeyFieldNamesResultResult: string[] }) => any, errorCallback?: () => any): JQueryPromise<{ GetGetAllKeyFieldNamesResultResult: string[] }>;

	GetGetAllKeyFieldNamesResult(requestId: string): { GetGetAllKeyFieldNamesResultResult: string[] };

	GetGetAllKeyFieldNamesResultPromise(requestId: string): Promise<string[]>;

	GetIdentityColumn(tableName: string, schemaName: string, databaseId: string, successCallback: (data: { GetIdentityColumnResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ GetIdentityColumnResult: string }>;

	GetIdentityColumn(tableName: string, schemaName: string, databaseId: string): { GetIdentityColumnResult: string };

	GetIdentityColumnPromise(tableName: string, schemaName: string, databaseId: string): Promise<string>;

	StartGetIdentityColumn(tableName: string, schemaName: string, connectionInfo: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData, successCallback: (data: { StartGetIdentityColumnResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ StartGetIdentityColumnResult: string }>;

	StartGetIdentityColumn(tableName: string, schemaName: string, connectionInfo: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData): { StartGetIdentityColumnResult: string };

	StartGetIdentityColumnPromise(tableName: string, schemaName: string, connectionInfo: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData): Promise<string>;

	GetIdentityColumnByRequest(requestId: string, successCallback: (data: { GetIdentityColumnByRequestResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ GetIdentityColumnByRequestResult: string }>;

	GetIdentityColumnByRequest(requestId: string): { GetIdentityColumnByRequestResult: string };

	GetIdentityColumnByRequestPromise(requestId: string): Promise<string>;

	CreateDatabaseData(dbType: $D.Framework.ServiceLayer.DataBaseTypeEnum, connectionString: string, dbName: string, agentId: string, useCurrentDatabase: boolean, flowId: string, successCallback: (data: { CreateDatabaseDataResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ CreateDatabaseDataResult: string }>;

	CreateDatabaseData(dbType: $D.Framework.ServiceLayer.DataBaseTypeEnum, connectionString: string, dbName: string, agentId: string, useCurrentDatabase: boolean, flowId: string): { CreateDatabaseDataResult: string };

	CreateDatabaseDataPromise(dbType: $D.Framework.ServiceLayer.DataBaseTypeEnum, connectionString: string, dbName: string, agentId: string, useCurrentDatabase: boolean, flowId: string): Promise<string>;

	GetDataBaseData(databaseId: string, successCallback: (data: { GetDataBaseDataResult: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData }) => any, errorCallback?: () => any): JQueryPromise<{ GetDataBaseDataResult: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData }>;

	GetDataBaseData(databaseId: string): { GetDataBaseDataResult: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData };

	GetDataBaseDataPromise(databaseId: string): Promise<$D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData>;

	ExistsDatabaseByName(databaseName: string, successCallback: (data: { ExistsDatabaseByNameResult: boolean }) => any, errorCallback?: () => any): JQueryPromise<{ ExistsDatabaseByNameResult: boolean }>;

	ExistsDatabaseByName(databaseName: string): { ExistsDatabaseByNameResult: boolean };

	ExistsDatabaseByNamePromise(databaseName: string): Promise<boolean>;

	CheckDatabaseName(databaseName: string, successCallback: (data: { CheckDatabaseNameResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ CheckDatabaseNameResult: string }>;

	CheckDatabaseName(databaseName: string): { CheckDatabaseNameResult: string };

	CheckDatabaseNamePromise(databaseName: string): Promise<string>;

	GetDatabaseTypeNames(successCallback: (data: { GetDatabaseTypeNamesResult: any }) => any, errorCallback?: () => any): JQueryPromise<{ GetDatabaseTypeNamesResult: any }>;

	GetDatabaseTypeNames(): { GetDatabaseTypeNamesResult: any };

	GetDatabaseTypeNamesPromise(): Promise<any>;

	GetConnectionStringTemplates(type: $D.Framework.ServiceLayer.DataBaseTypeEnum, successCallback: (data: { GetConnectionStringTemplatesResult: string[] }) => any, errorCallback?: () => any): JQueryPromise<{ GetConnectionStringTemplatesResult: string[] }>;

	GetConnectionStringTemplates(type: $D.Framework.ServiceLayer.DataBaseTypeEnum): { GetConnectionStringTemplatesResult: string[] };

	GetConnectionStringTemplatesPromise(type: $D.Framework.ServiceLayer.DataBaseTypeEnum): Promise<string[]>;

	CreateConnectionString(type: $D.Framework.ServiceLayer.DataBaseTypeEnum, parameters: $D.Framework.ServiceLayer.Services.ContextData.DataPair[], successCallback: (data: { CreateConnectionStringResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ CreateConnectionStringResult: string }>;

	CreateConnectionString(type: $D.Framework.ServiceLayer.DataBaseTypeEnum, parameters: $D.Framework.ServiceLayer.Services.ContextData.DataPair[]): { CreateConnectionStringResult: string };

	CreateConnectionStringPromise(type: $D.Framework.ServiceLayer.DataBaseTypeEnum, parameters: $D.Framework.ServiceLayer.Services.ContextData.DataPair[]): Promise<string>;

	GetDriver(databaseId: string, successCallback: (data: { GetDriverResult: any }) => any, errorCallback?: () => any): JQueryPromise<{ GetDriverResult: any }>;

	GetDriver(databaseId: string): { GetDriverResult: any };

	GetDriverPromise(databaseId: string): Promise<any>;

	GetDynamicTypeName(definitionId: string, successCallback: (data: { GetDynamicTypeNameResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ GetDynamicTypeNameResult: string }>;

	GetDynamicTypeName(definitionId: string): { GetDynamicTypeNameResult: string };

	GetDynamicTypeNamePromise(definitionId: string): Promise<string>;

	GetODBCMetadataFlowContextId(connectionString: string, successCallback: (data: { GetODBCMetadataFlowContextIdResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ GetODBCMetadataFlowContextIdResult: string }>;

	GetODBCMetadataFlowContextId(connectionString: string): { GetODBCMetadataFlowContextIdResult: string };

	GetODBCMetadataFlowContextIdPromise(connectionString: string): Promise<string>;

	GetODBCMetadataFlowIdFromContextId(contectId: string, successCallback: (data: { GetODBCMetadataFlowIdFromContextIdResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ GetODBCMetadataFlowIdFromContextIdResult: string }>;

	GetODBCMetadataFlowIdFromContextId(contectId: string): { GetODBCMetadataFlowIdFromContextIdResult: string };

	GetODBCMetadataFlowIdFromContextIdPromise(contectId: string): Promise<string>;
	...
	Create(name: string, description: string, parentFolderID: string, data: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData, successCallback: (data: { CreateResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ CreateResult: string }>;

	Create(name: string, description: string, parentFolderID: string, data: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData): { CreateResult: string };

	CreatePromise(name: string, description: string, parentFolderID: string, data: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData): Promise<string>;

	FetchData(folderEntityID: string, successCallback: (data: { FetchDataResult: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData }) => any, errorCallback?: () => any): JQueryPromise<{ FetchDataResult: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData }>;

	FetchData(folderEntityID: string): { FetchDataResult: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData };

	FetchDataPromise(folderEntityID: string): Promise<$D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData>;
	...
	SaveFolderWithData(folderEntityID: string, data: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData, successCallback: (data: { SaveFolderWithDataResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ SaveFolderWithDataResult: void }>;

	SaveFolderWithData(folderEntityID: string, data: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData): { SaveFolderWithDataResult: void };

	SaveFolderWithDataPromise(folderEntityID: string, data: $D.Framework.ServiceLayer.Services.DatabaseIntegration.DatabaseData): Promise<void>;
}

interface ServicesStatic {
	DatabaseDataService(): DatabaseDataServiceStatic;
}
