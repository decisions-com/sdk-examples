...
interface WebHookServiceStatic {
	...
	Create(name: string, description: string, parentFolderID: string, data: any, successCallback: (data: { CreateResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ CreateResult: string }>;

	Create(name: string, description: string, parentFolderID: string, data: any): { CreateResult: string };

	CreatePromise(name: string, description: string, parentFolderID: string, data: any): Promise<string>;

	FetchData(folderEntityID: string, successCallback: (data: { FetchDataResult: any }) => any, errorCallback?: () => any): JQueryPromise<{ FetchDataResult: any }>;

	FetchData(folderEntityID: string): { FetchDataResult: any };

	FetchDataPromise(folderEntityID: string): Promise<any>;
	...
	SaveFolderWithData(folderEntityID: string, data: any, successCallback: (data: { SaveFolderWithDataResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ SaveFolderWithDataResult: void }>;

	SaveFolderWithData(folderEntityID: string, data: any): { SaveFolderWithDataResult: void };

	SaveFolderWithDataPromise(folderEntityID: string, data: any): Promise<void>;
...
interface ServicesStatic {
	WebHookService(): WebHookServiceStatic;
}
