...
interface ModuleInstallationServiceStatic {
	...
	UnInstallModule(moduleName: string, successCallback: (data: { UnInstallModuleResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ UnInstallModuleResult: void }>;

	UnInstallModule(moduleName: string): { UnInstallModuleResult: void };

	UnInstallModulePromise(moduleName: string): Promise<void>;

	CreateModule(name: string, imported: boolean, successCallback: (data: { CreateModuleResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ CreateModuleResult: string }>;

	CreateModule(name: string, imported: boolean): { CreateModuleResult: string };

	CreateModulePromise(name: string, imported: boolean): Promise<string>;

	ExportModule(moduleFolderId: string, successCallback: (data: { ExportModuleResult: $D.Framework.Data.DataTypes.FileData }) => any, errorCallback?: () => any): JQueryPromise<{ ExportModuleResult: $D.Framework.Data.DataTypes.FileData }>;

	ExportModule(moduleFolderId: string): { ExportModuleResult: $D.Framework.Data.DataTypes.FileData };

	ExportModulePromise(moduleFolderId: string): Promise<$D.Framework.Data.DataTypes.FileData>;

	AddModule(folderId: string, name: string, successCallback: (data: { AddModuleResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ AddModuleResult: void }>;

	AddModule(folderId: string, name: string): { AddModuleResult: void };

	AddModulePromise(folderId: string, name: string): Promise<void>;

	GetFeaturesList(successCallback: (data: { GetFeaturesListResult: $D.Framework.ServiceLayer.Services.Module.ModuleInfo[] }) => any, errorCallback?: () => any): JQueryPromise<{ GetFeaturesListResult: $D.Framework.ServiceLayer.Services.Module.ModuleInfo[] }>;

	GetFeaturesList(): { GetFeaturesListResult: $D.Framework.ServiceLayer.Services.Module.ModuleInfo[] };

	GetFeaturesListPromise(): Promise<$D.Framework.ServiceLayer.Services.Module.ModuleInfo[]>;
	...
	Create(name: string, description: string, parentFolderID: string, data: $D.Framework.ServiceLayer.Services.Modules.ModuleInstallation, successCallback: (data: { CreateResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ CreateResult: string }>;

	Create(name: string, description: string, parentFolderID: string, data: $D.Framework.ServiceLayer.Services.Modules.ModuleInstallation): { CreateResult: string };

	CreatePromise(name: string, description: string, parentFolderID: string, data: $D.Framework.ServiceLayer.Services.Modules.ModuleInstallation): Promise<string>;

	FetchData(folderEntityID: string, successCallback: (data: { FetchDataResult: $D.Framework.ServiceLayer.Services.Modules.ModuleInstallation }) => any, errorCallback?: () => any): JQueryPromise<{ FetchDataResult: $D.Framework.ServiceLayer.Services.Modules.ModuleInstallation }>;

	FetchData(folderEntityID: string): { FetchDataResult: $D.Framework.ServiceLayer.Services.Modules.ModuleInstallation };

	FetchDataPromise(folderEntityID: string): Promise<$D.Framework.ServiceLayer.Services.Modules.ModuleInstallation>;
	...
	SaveFolderWithData(folderEntityID: string, data: $D.Framework.ServiceLayer.Services.Modules.ModuleInstallation, successCallback: (data: { SaveFolderWithDataResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ SaveFolderWithDataResult: void }>;

	SaveFolderWithData(folderEntityID: string, data: $D.Framework.ServiceLayer.Services.Modules.ModuleInstallation): { SaveFolderWithDataResult: void };

	SaveFolderWithDataPromise(folderEntityID: string, data: $D.Framework.ServiceLayer.Services.Modules.ModuleInstallation): Promise<void>;
}

interface ServicesStatic {
	ModuleInstallationService(): ModuleInstallationServiceStatic;
}
