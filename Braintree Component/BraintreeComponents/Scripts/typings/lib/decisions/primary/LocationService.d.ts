...
interface LocationServiceStatic {

	SetDefaultLocation(locationID: string, successCallback: (data: { SetDefaultLocationResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ SetDefaultLocationResult: void }>;

	SetDefaultLocation(locationID: string): { SetDefaultLocationResult: void };

	SetDefaultLocationPromise(locationID: string): Promise<void>;

	GetDefaultLocation(successCallback: (data: { GetDefaultLocationResult: $D.Framework.ServiceLayer.Services.Location.Location }) => any, errorCallback?: () => any): JQueryPromise<{ GetDefaultLocationResult: $D.Framework.ServiceLayer.Services.Location.Location }>;

	GetDefaultLocation(): { GetDefaultLocationResult: $D.Framework.ServiceLayer.Services.Location.Location };

	GetDefaultLocationPromise(): Promise<$D.Framework.ServiceLayer.Services.Location.Location>;

	DeleteLocation(entityid: string, successCallback: (data: { DeleteLocationResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ DeleteLocationResult: void }>;

	DeleteLocation(entityid: string): { DeleteLocationResult: void };

	DeleteLocationPromise(entityid: string): Promise<void>;

	GetLocationByName(locationName: string, successCallback: (data: { GetLocationByNameResult: $D.Framework.ServiceLayer.Services.Location.Location }) => any, errorCallback?: () => any): JQueryPromise<{ GetLocationByNameResult: $D.Framework.ServiceLayer.Services.Location.Location }>;

	GetLocationByName(locationName: string): { GetLocationByNameResult: $D.Framework.ServiceLayer.Services.Location.Location };

	GetLocationByNamePromise(locationName: string): Promise<$D.Framework.ServiceLayer.Services.Location.Location>;

	GetLocationByID(locationId: string, successCallback: (data: { GetLocationByIDResult: $D.Framework.ServiceLayer.Services.Location.Location }) => any, errorCallback?: () => any): JQueryPromise<{ GetLocationByIDResult: $D.Framework.ServiceLayer.Services.Location.Location }>;

	GetLocationByID(locationId: string): { GetLocationByIDResult: $D.Framework.ServiceLayer.Services.Location.Location };

	GetLocationByIDPromise(locationId: string): Promise<$D.Framework.ServiceLayer.Services.Location.Location>;

	GetLocations(successCallback: (data: { GetLocationsResult: $D.Framework.ServiceLayer.Services.Location.Location[] }) => any, errorCallback?: () => any): JQueryPromise<{ GetLocationsResult: $D.Framework.ServiceLayer.Services.Location.Location[] }>;

	GetLocations(): { GetLocationsResult: $D.Framework.ServiceLayer.Services.Location.Location[] };

	GetLocationsPromise(): Promise<$D.Framework.ServiceLayer.Services.Location.Location[]>;
	...
	Create(name: string, description: string, parentFolderID: string, data: $D.Framework.ServiceLayer.Services.Location.Location, successCallback: (data: { CreateResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ CreateResult: string }>;

	Create(name: string, description: string, parentFolderID: string, data: $D.Framework.ServiceLayer.Services.Location.Location): { CreateResult: string };

	CreatePromise(name: string, description: string, parentFolderID: string, data: $D.Framework.ServiceLayer.Services.Location.Location): Promise<string>;

	FetchData(folderEntityID: string, successCallback: (data: { FetchDataResult: $D.Framework.ServiceLayer.Services.Location.Location }) => any, errorCallback?: () => any): JQueryPromise<{ FetchDataResult: $D.Framework.ServiceLayer.Services.Location.Location }>;

	FetchData(folderEntityID: string): { FetchDataResult: $D.Framework.ServiceLayer.Services.Location.Location };

	FetchDataPromise(folderEntityID: string): Promise<$D.Framework.ServiceLayer.Services.Location.Location>;
	...
	SaveFolderWithData(folderEntityID: string, data: $D.Framework.ServiceLayer.Services.Location.Location, successCallback: (data: { SaveFolderWithDataResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ SaveFolderWithDataResult: void }>;

	SaveFolderWithData(folderEntityID: string, data: $D.Framework.ServiceLayer.Services.Location.Location): { SaveFolderWithDataResult: void };

	SaveFolderWithDataPromise(folderEntityID: string, data: $D.Framework.ServiceLayer.Services.Location.Location): Promise<void>;
}

interface ServicesStatic {
	LocationService(): LocationServiceStatic;
}
