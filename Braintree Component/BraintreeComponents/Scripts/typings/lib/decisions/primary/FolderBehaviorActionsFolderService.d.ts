...
interface FolderBehaviorActionsFolderServiceStatic {

	CreateFolderBehaviorActionFlow(folderId: string, name: string, templateId: string, successCallback: (data: { CreateFolderBehaviorActionFlowResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ CreateFolderBehaviorActionFlowResult: string }>;

	CreateFolderBehaviorActionFlow(folderId: string, name: string, templateId: string): { CreateFolderBehaviorActionFlowResult: string };

	CreateFolderBehaviorActionFlowPromise(folderId: string, name: string, templateId: string): Promise<string>;
	...
	Create(name: string, description: string, parentFolderID: string, data: $D.Framework.Design.EntityActions.FolderBehaviorActionsFolderExtention, successCallback: (data: { CreateResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ CreateResult: string }>;

	Create(name: string, description: string, parentFolderID: string, data: $D.Framework.Design.EntityActions.FolderBehaviorActionsFolderExtention): { CreateResult: string };

	CreatePromise(name: string, description: string, parentFolderID: string, data: $D.Framework.Design.EntityActions.FolderBehaviorActionsFolderExtention): Promise<string>;

	FetchData(folderEntityID: string, successCallback: (data: { FetchDataResult: $D.Framework.Design.EntityActions.FolderBehaviorActionsFolderExtention }) => any, errorCallback?: () => any): JQueryPromise<{ FetchDataResult: $D.Framework.Design.EntityActions.FolderBehaviorActionsFolderExtention }>;

	FetchData(folderEntityID: string): { FetchDataResult: $D.Framework.Design.EntityActions.FolderBehaviorActionsFolderExtention };

	FetchDataPromise(folderEntityID: string): Promise<$D.Framework.Design.EntityActions.FolderBehaviorActionsFolderExtention>;
	...
	SaveFolderWithData(folderEntityID: string, data: $D.Framework.Design.EntityActions.FolderBehaviorActionsFolderExtention, successCallback: (data: { SaveFolderWithDataResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ SaveFolderWithDataResult: void }>;

	SaveFolderWithData(folderEntityID: string, data: $D.Framework.Design.EntityActions.FolderBehaviorActionsFolderExtention): { SaveFolderWithDataResult: void };

	SaveFolderWithDataPromise(folderEntityID: string, data: $D.Framework.Design.EntityActions.FolderBehaviorActionsFolderExtention): Promise<void>;
}

interface ServicesStatic {
	FolderBehaviorActionsFolderService(): FolderBehaviorActionsFolderServiceStatic;
}
