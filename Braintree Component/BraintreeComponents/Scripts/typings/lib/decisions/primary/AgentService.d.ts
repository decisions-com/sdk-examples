...
interface AgentServiceStatic {

	RegisterAgent(agentName: string, description: string, parentFolderID: string, data: $D.Framework.ServiceLayer.Services.Agent.AgentData, successCallback: (data: { RegisterAgentResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ RegisterAgentResult: string }>;

	RegisterAgent(agentName: string, description: string, parentFolderID: string, data: $D.Framework.ServiceLayer.Services.Agent.AgentData): { RegisterAgentResult: string };

	RegisterAgentPromise(agentName: string, description: string, parentFolderID: string, data: $D.Framework.ServiceLayer.Services.Agent.AgentData): Promise<string>;

	Handshake(agentId: string, computerName: string, ip: string, encryptedData: string, successCallback: (data: { HandshakeResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ HandshakeResult: string }>;

	Handshake(agentId: string, computerName: string, ip: string, encryptedData: string): { HandshakeResult: string };

	HandshakePromise(agentId: string, computerName: string, ip: string, encryptedData: string): Promise<string>;

	ReportIdentity(agentID: string, computerName: string, uuid: string, ip: string[], mac: string, agentPublicKey: string, successCallback: (data: { ReportIdentityResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ ReportIdentityResult: void }>;

	ReportIdentity(agentID: string, computerName: string, uuid: string, ip: string[], mac: string, agentPublicKey: string): { ReportIdentityResult: void };

	ReportIdentityPromise(agentID: string, computerName: string, uuid: string, ip: string[], mac: string, agentPublicKey: string): Promise<void>;

	Ping(agentID: string, successCallback: (data: { PingResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ PingResult: void }>;

	Ping(agentID: string): { PingResult: void };

	PingPromise(agentID: string): Promise<void>;

	RespondToPing(ipOfAgent: string, idOfInstruction: string, agentPort: string, computerName: string, successCallback: (data: { RespondToPingResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ RespondToPingResult: void }>;

	RespondToPing(ipOfAgent: string, idOfInstruction: string, agentPort: string, computerName: string): { RespondToPingResult: void };

	RespondToPingPromise(ipOfAgent: string, idOfInstruction: string, agentPort: string, computerName: string): Promise<void>;

	InstructAgent(agentId: string, agent: $D.Framework.ServiceLayer.Agent.AgentInstructions, successCallback: (data: { InstructAgentResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ InstructAgentResult: void }>;

	InstructAgent(agentId: string, agent: $D.Framework.ServiceLayer.Agent.AgentInstructions): { InstructAgentResult: void };

	InstructAgentPromise(agentId: string, agent: $D.Framework.ServiceLayer.Agent.AgentInstructions): Promise<void>;

	InstructAgentSync(agentId: string, agent: $D.Framework.ServiceLayer.Agent.AgentInstructions, successCallback: (data: { InstructAgentSyncResult: $D.Framework.ServiceLayer.Services.ContextData.DataPair[] }) => any, errorCallback?: () => any): JQueryPromise<{ InstructAgentSyncResult: $D.Framework.ServiceLayer.Services.ContextData.DataPair[] }>;

	InstructAgentSync(agentId: string, agent: $D.Framework.ServiceLayer.Agent.AgentInstructions): { InstructAgentSyncResult: $D.Framework.ServiceLayer.Services.ContextData.DataPair[] };

	InstructAgentSyncPromise(agentId: string, agent: $D.Framework.ServiceLayer.Agent.AgentInstructions): Promise<$D.Framework.ServiceLayer.Services.ContextData.DataPair[]>;

	InstructAgentWithDelayedWakeup(agentId: string, instructions: $D.Framework.ServiceLayer.Agent.AgentInstructions, wakeupDateTimeIfNotPickedUp: any, successCallback: (data: { InstructAgentWithDelayedWakeupResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ InstructAgentWithDelayedWakeupResult: void }>;

	InstructAgentWithDelayedWakeup(agentId: string, instructions: $D.Framework.ServiceLayer.Agent.AgentInstructions, wakeupDateTimeIfNotPickedUp: any): { InstructAgentWithDelayedWakeupResult: void };

	InstructAgentWithDelayedWakeupPromise(agentId: string, instructions: $D.Framework.ServiceLayer.Agent.AgentInstructions, wakeupDateTimeIfNotPickedUp: any): Promise<void>;

	InstructAgentWithoutWakeup(agentId: string, instructions: $D.Framework.ServiceLayer.Agent.AgentInstructions, successCallback: (data: { InstructAgentWithoutWakeupResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ InstructAgentWithoutWakeupResult: void }>;

	InstructAgentWithoutWakeup(agentId: string, instructions: $D.Framework.ServiceLayer.Agent.AgentInstructions): { InstructAgentWithoutWakeupResult: void };

	InstructAgentWithoutWakeupPromise(agentId: string, instructions: $D.Framework.ServiceLayer.Agent.AgentInstructions): Promise<void>;

	InstructAgentToRunFlow(agentId: string, flowId: string, successCallback: (data: { InstructAgentToRunFlowResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ InstructAgentToRunFlowResult: void }>;

	InstructAgentToRunFlow(agentId: string, flowId: string): { InstructAgentToRunFlowResult: void };

	InstructAgentToRunFlowPromise(agentId: string, flowId: string): Promise<void>;

	GetInstructions(userContext: $D.Framework.ServiceLayer.Utilities.AbstractUserContext, request: $D.Framework.ServiceLayer.Agent.AgentInstructionsRequest, successCallback: (data: { GetInstructionsResult: $D.Framework.ServiceLayer.Agent.AgentInstructions[] }) => any, errorCallback?: () => any): JQueryPromise<{ GetInstructionsResult: $D.Framework.ServiceLayer.Agent.AgentInstructions[] }>;

	GetInstructions(userContext: $D.Framework.ServiceLayer.Utilities.AbstractUserContext, request: $D.Framework.ServiceLayer.Agent.AgentInstructionsRequest): { GetInstructionsResult: $D.Framework.ServiceLayer.Agent.AgentInstructions[] };

	GetInstructionsPromise(userContext: $D.Framework.ServiceLayer.Utilities.AbstractUserContext, request: $D.Framework.ServiceLayer.Agent.AgentInstructionsRequest): Promise<$D.Framework.ServiceLayer.Agent.AgentInstructions[]>;

	PostAgentStatus(userContext: $D.Framework.ServiceLayer.Utilities.AbstractUserContext, request: $D.Framework.ServiceLayer.Agent.AgentInstructionsRequest, successCallback: (data: { PostAgentStatusResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ PostAgentStatusResult: void }>;

	PostAgentStatus(userContext: $D.Framework.ServiceLayer.Utilities.AbstractUserContext, request: $D.Framework.ServiceLayer.Agent.AgentInstructionsRequest): { PostAgentStatusResult: void };

	PostAgentStatusPromise(userContext: $D.Framework.ServiceLayer.Utilities.AbstractUserContext, request: $D.Framework.ServiceLayer.Agent.AgentInstructionsRequest): Promise<void>;

	GetAgentDefinitionForClient(agentId: string, successCallback: (data: { GetAgentDefinitionForClientResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ GetAgentDefinitionForClientResult: string }>;

	GetAgentDefinitionForClient(agentId: string): { GetAgentDefinitionForClientResult: string };

	GetAgentDefinitionForClientPromise(agentId: string): Promise<string>;

	UploadDocument(agentId: string, document: $D.Framework.ServiceLayer.Actions.Common.TitleDescriptionAndFile, successCallback: (data: { UploadDocumentResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ UploadDocumentResult: string }>;

	UploadDocument(agentId: string, document: $D.Framework.ServiceLayer.Actions.Common.TitleDescriptionAndFile): { UploadDocumentResult: string };

	UploadDocumentPromise(agentId: string, document: $D.Framework.ServiceLayer.Actions.Common.TitleDescriptionAndFile): Promise<string>;

	PostResult(userContext: $D.Framework.ServiceLayer.Utilities.AbstractUserContext, agentId: string, instructionId: string, r: $D.Framework.ServiceLayer.Agent.AgentInstructionsResult, successCallback: (data: { PostResultResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ PostResultResult: void }>;

	PostResult(userContext: $D.Framework.ServiceLayer.Utilities.AbstractUserContext, agentId: string, instructionId: string, r: $D.Framework.ServiceLayer.Agent.AgentInstructionsResult): { PostResultResult: void };

	PostResultPromise(userContext: $D.Framework.ServiceLayer.Utilities.AbstractUserContext, agentId: string, instructionId: string, r: $D.Framework.ServiceLayer.Agent.AgentInstructionsResult): Promise<void>;

	PostTimeout(agentId: string, instructionId: string, successCallback: (data: { PostTimeoutResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ PostTimeoutResult: void }>;

	PostTimeout(agentId: string, instructionId: string): { PostTimeoutResult: void };

	PostTimeoutPromise(agentId: string, instructionId: string): Promise<void>;

	PostError(agentId: string, instructionId: string, errorDetails: string, successCallback: (data: { PostErrorResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ PostErrorResult: void }>;

	PostError(agentId: string, instructionId: string, errorDetails: string): { PostErrorResult: void };

	PostErrorPromise(agentId: string, instructionId: string, errorDetails: string): Promise<void>;

	PostStart(agentId: string, instructionId: string, successCallback: (data: { PostStartResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ PostStartResult: void }>;

	PostStart(agentId: string, instructionId: string): { PostStartResult: void };

	PostStartPromise(agentId: string, instructionId: string): Promise<void>;

	PostEnd(agentId: string, instructionId: string, successCallback: (data: { PostEndResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ PostEndResult: void }>;

	PostEnd(agentId: string, instructionId: string): { PostEndResult: void };

	PostEndPromise(agentId: string, instructionId: string): Promise<void>;

	PostStatus(agentId: string, instructionId: string, statusDateTime: Date, statusMessage: string, successCallback: (data: { PostStatusResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ PostStatusResult: void }>;

	PostStatus(agentId: string, instructionId: string, statusDateTime: Date, statusMessage: string): { PostStatusResult: void };

	PostStatusPromise(agentId: string, instructionId: string, statusDateTime: Date, statusMessage: string): Promise<void>;

	SendWakeup(wakeupAgentId: string, successCallback: (data: { SendWakeupResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ SendWakeupResult: void }>;

	SendWakeup(wakeupAgentId: string): { SendWakeupResult: void };

	SendWakeupPromise(wakeupAgentId: string): Promise<void>;

	RegisterClientEventWakeupForUser(wakeupAgent: string, userId: string, successCallback: (data: { RegisterClientEventWakeupForUserResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ RegisterClientEventWakeupForUserResult: void }>;

	RegisterClientEventWakeupForUser(wakeupAgent: string, userId: string): { RegisterClientEventWakeupForUserResult: void };

	RegisterClientEventWakeupForUserPromise(wakeupAgent: string, userId: string): Promise<void>;

	DeRegisterClientEventWakeupForUser(wakeupAgent: string, userId: string, successCallback: (data: { DeRegisterClientEventWakeupForUserResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ DeRegisterClientEventWakeupForUserResult: void }>;

	DeRegisterClientEventWakeupForUser(wakeupAgent: string, userId: string): { DeRegisterClientEventWakeupForUserResult: void };

	DeRegisterClientEventWakeupForUserPromise(wakeupAgent: string, userId: string): Promise<void>;

	RegisterClientEventWakeupForEvents(wakeupAgent: string, eventIds: string[], successCallback: (data: { RegisterClientEventWakeupForEventsResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ RegisterClientEventWakeupForEventsResult: void }>;

	RegisterClientEventWakeupForEvents(wakeupAgent: string, eventIds: string[]): { RegisterClientEventWakeupForEventsResult: void };

	RegisterClientEventWakeupForEventsPromise(wakeupAgent: string, eventIds: string[]): Promise<void>;

	DeRegisterClientEventWakeupForEvents(wakeupAgent: string, eventIds: string[], successCallback: (data: { DeRegisterClientEventWakeupForEventsResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ DeRegisterClientEventWakeupForEventsResult: void }>;

	DeRegisterClientEventWakeupForEvents(wakeupAgent: string, eventIds: string[]): { DeRegisterClientEventWakeupForEventsResult: void };

	DeRegisterClientEventWakeupForEventsPromise(wakeupAgent: string, eventIds: string[]): Promise<void>;

	GetEventsForAgent(agentID: string, successCallback: (data: { GetEventsForAgentResult: $D.Framework.ServiceLayer.Services.ContextData.DataPair[] }) => any, errorCallback?: () => any): JQueryPromise<{ GetEventsForAgentResult: $D.Framework.ServiceLayer.Services.ContextData.DataPair[] }>;

	GetEventsForAgent(agentID: string): { GetEventsForAgentResult: $D.Framework.ServiceLayer.Services.ContextData.DataPair[] };

	GetEventsForAgentPromise(agentID: string): Promise<$D.Framework.ServiceLayer.Services.ContextData.DataPair[]>;

	RegisterAgentForEvent(agentID: string, agentEvent: $D.Framework.ServiceLayer.Services.Agent.AgentEvents, successCallback: (data: { RegisterAgentForEventResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ RegisterAgentForEventResult: void }>;

	RegisterAgentForEvent(agentID: string, agentEvent: $D.Framework.ServiceLayer.Services.Agent.AgentEvents): { RegisterAgentForEventResult: void };

	RegisterAgentForEventPromise(agentID: string, agentEvent: $D.Framework.ServiceLayer.Services.Agent.AgentEvents): Promise<void>;

	RequestAgentDownload(parentFolderId: string, successCallback: (data: { RequestAgentDownloadResult: $D.Framework.Data.DataTypes.FileData }) => any, errorCallback?: () => any): JQueryPromise<{ RequestAgentDownloadResult: $D.Framework.Data.DataTypes.FileData }>;

	RequestAgentDownload(parentFolderId: string): { RequestAgentDownloadResult: $D.Framework.Data.DataTypes.FileData };

	RequestAgentDownloadPromise(parentFolderId: string): Promise<$D.Framework.Data.DataTypes.FileData>;

	GetAgentInstructionsById(agentInstructionsId: string, successCallback: (data: { GetAgentInstructionsByIdResult: $D.Framework.ServiceLayer.Agent.AgentInstructions }) => any, errorCallback?: () => any): JQueryPromise<{ GetAgentInstructionsByIdResult: $D.Framework.ServiceLayer.Agent.AgentInstructions }>;

	GetAgentInstructionsById(agentInstructionsId: string): { GetAgentInstructionsByIdResult: $D.Framework.ServiceLayer.Agent.AgentInstructions };

	GetAgentInstructionsByIdPromise(agentInstructionsId: string): Promise<$D.Framework.ServiceLayer.Agent.AgentInstructions>;

	GetAgentInstructionsData(agentInstructionsId: string, key: string, successCallback: (data: { GetAgentInstructionsDataResult: any }) => any, errorCallback?: () => any): JQueryPromise<{ GetAgentInstructionsDataResult: any }>;

	GetAgentInstructionsData(agentInstructionsId: string, key: string): { GetAgentInstructionsDataResult: any };

	GetAgentInstructionsDataPromise(agentInstructionsId: string, key: string): Promise<any>;

	GetAgentInstructionsError(agentInstructionsId: string, successCallback: (data: { GetAgentInstructionsErrorResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ GetAgentInstructionsErrorResult: string }>;

	GetAgentInstructionsError(agentInstructionsId: string): { GetAgentInstructionsErrorResult: string };

	GetAgentInstructionsErrorPromise(agentInstructionsId: string): Promise<string>;

	GetAllAgents(successCallback: (data: { GetAllAgentsResult: $D.Framework.ServiceLayer.Services.Folder.Folder[] }) => any, errorCallback?: () => any): JQueryPromise<{ GetAllAgentsResult: $D.Framework.ServiceLayer.Services.Folder.Folder[] }>;

	GetAllAgents(): { GetAllAgentsResult: $D.Framework.ServiceLayer.Services.Folder.Folder[] };

	GetAllAgentsPromise(): Promise<$D.Framework.ServiceLayer.Services.Folder.Folder[]>;
	...
	Create(name: string, description: string, parentFolderID: string, data: $D.Framework.ServiceLayer.Services.Agent.AgentData, successCallback: (data: { CreateResult: string }) => any, errorCallback?: () => any): JQueryPromise<{ CreateResult: string }>;

	Create(name: string, description: string, parentFolderID: string, data: $D.Framework.ServiceLayer.Services.Agent.AgentData): { CreateResult: string };

	CreatePromise(name: string, description: string, parentFolderID: string, data: $D.Framework.ServiceLayer.Services.Agent.AgentData): Promise<string>;

	FetchData(folderEntityID: string, successCallback: (data: { FetchDataResult: $D.Framework.ServiceLayer.Services.Agent.AgentData }) => any, errorCallback?: () => any): JQueryPromise<{ FetchDataResult: $D.Framework.ServiceLayer.Services.Agent.AgentData }>;

	FetchData(folderEntityID: string): { FetchDataResult: $D.Framework.ServiceLayer.Services.Agent.AgentData };

	FetchDataPromise(folderEntityID: string): Promise<$D.Framework.ServiceLayer.Services.Agent.AgentData>;
	...
	SaveFolderWithData(folderEntityID: string, data: $D.Framework.ServiceLayer.Services.Agent.AgentData, successCallback: (data: { SaveFolderWithDataResult: void }) => any, errorCallback?: () => any): JQueryPromise<{ SaveFolderWithDataResult: void }>;

	SaveFolderWithData(folderEntityID: string, data: $D.Framework.ServiceLayer.Services.Agent.AgentData): { SaveFolderWithDataResult: void };

	SaveFolderWithDataPromise(folderEntityID: string, data: $D.Framework.ServiceLayer.Services.Agent.AgentData): Promise<void>;
}

interface ServicesStatic {
	AgentService(): AgentServiceStatic;
}
